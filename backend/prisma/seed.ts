import { CustomerStatus, CustomerType, MovementType, PrismaClient, Role } from '@prisma/client';
...
async function main() {
  ...
  for (const customerData of customersData) {
    // This preserves legacy development rows once; new rows use deterministic IDs.

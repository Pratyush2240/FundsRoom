...
const PortalLayout: React.FC = () => {
  ...
  const currentId = location.pathname === '/customers' ? 'customers' : location.pathname === '/products' ? 'products' : location.pathname === '/inventory' ? 'inventory' : activePlaceholder;
...
export default function App() { return <AuthProvider><BrowserRouter><Routes><Route path="/login" element={<LoginPage />} /><Route element={<ProtectedRoute />}><Route path="/dashboard" element={<PortalLayout />} /><Route path="/customers" element={<PortalLayout />} /><Route path="/products" element={<PortalLayout />} /><Route path="/inventory" element={<PortalLayout />} /></Route><Route path="*" element={<Navigate to="/dashboard" replace />} /></Routes></BrowserRouter></AuthProvider>; }
